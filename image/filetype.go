...
func FileInit() {
	...
	fileTypeMap.Store("ffd8ffe1251245786966", "jpeg") //JPEG (jpeg) // my add
	...
	//fileTypeMap.Store("00000020667479706d70", "mp4") // old

	fileTypeMap.Store("00000018667479706d70", "mp4") // my add
